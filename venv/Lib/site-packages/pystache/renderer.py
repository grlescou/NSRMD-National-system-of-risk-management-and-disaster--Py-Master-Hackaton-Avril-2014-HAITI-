...
"""
This module provides a Renderer class to render template.
...
class Renderer(object):
    ...
    """
    A class for rendering mustache template.
    ...
    def __init__(self, file_encoding=None, string_encoding=None,
        ...
        Arguments:
          ...
          file_encoding: the name of the encoding to use by default when
            reading template files.  All template are converted to unicode
          ...
          partials: an object (e.g. a dictionary) for custom partial loading
            ...
            the normal procedure of locating and reading template from
